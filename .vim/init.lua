...
local plugins_spec = {
  ...
  { 'hrsh7th/nvim-cmp' },
  {
    ...
    config = function()
      ...
      vim.keymap.set("i", "<C-e>", function() neocodeium.cycle_or_complete() end)
      -- make sure to have a mapping to accept a completion
      vim.keymap.set("i", "<C-i>", function() neocodeium.accept() end)
    end,
  },
  {
  ...
  { 'nvim-lua/plenary.nvim' },
  {
    ...
    opts = {
      tips = {
        ...
        "Modification: '<localleader>r' renames a word across the whole file.",
        ...
        "Modification: '<localleader>r' starts a language server rename.",
