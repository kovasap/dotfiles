...
compton \
    ...
    --glx-prog-win-rule ~kovas/compton-chg-saturate-brightness-contrast-medium.glsl:'!(class_g="kitty" || class_g="Strawberry" || name="qtile_bar" || name="Dark and Darker  " || class_g="Google-chrome")' \
    --backend glx \
